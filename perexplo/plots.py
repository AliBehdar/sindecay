...
def plot(episode, cfg, reward_history, epsilon_history, loss_history):
    ...
    # Use a font that is bundled with Matplotlib to avoid findfont warnings.
    plt.rcParams.update({
        'font.family': 'DejaVu Serif',   # safe default (no findfont warnings)
        'font.size': 14,
    ...
    # Make tick labels bold (optional)
